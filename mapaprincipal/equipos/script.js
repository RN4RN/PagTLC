...
function mostrarDescripcion(elemento) {
    const estadoTexto = elemento.dataset.estado;
    const barraEstadoElement = document.getElementById('barraEstadoVentana');
    const textoEstadoElement = document.getElementById('EstadoEquip');
  
    let estadoColor = '';
    let porcentajeAncho = 0;
  
    if (estadoTexto === 'Bueno') {
      estadoColor = '#b2eccf';
      porcentajeAncho = 100;
    } else if (estadoTexto === 'Aceptable') {
      estadoColor = 'yellow';
      porcentajeAncho = 56;
    } else if (estadoTexto === 'Malo') {
      estadoColor = 'red';
      porcentajeAncho = 5;
    } else {
      estadoColor = 'gray';
    ...
    barraEstadoElement.style.width = `${porcentajeAncho}%`;
    barraEstadoElement.style.backgroundColor = estadoColor;
  }