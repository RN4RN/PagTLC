...
<a href="Record_historico_movimientos.php"><button class="boton-elegante" style="margin: 0px 20px;"><h3 class="text-center text-white mt-4 mb-3" style="margin: 1px 20px;">Historial de <br>
         Movimientos</h3></button></a>
 <br>
