...
include("conexion1.php"); // Tu archivo de conexión a la BD ($conexion)
...
<nav class="navbar navbar-expand-lg navbar-custom fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="?section=dashboard"><i class="fas fa-tachometer-alt me-2"></i>Panel Director</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDirector">
            ...
            <img src="<?php echo htmlspecialchars($director_foto); ?>" alt="Perfil" class="profile-img-nav me-2">
             <a href="http://localhost/nuevo/contraseña/mapaprincipal/index.php" class="btn btn-sm btn-outline-light me-2" title="Volver al Mapa Principal">
                <i class="fas fa-arrow-left"></i> 
            </a>
            <a href="logout.php" class="btn btn-sm btn-danger" title="Cerrar Sesión"><i class="fas fa-sign-out-alt"></i></a>
        </div>
    </div>
</nav>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="equipment-panel">
                        <?php if ($resultadoEntregados && $resultadoEntregados->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <p class="text-center p-3 text-muted">No hay equipos entregados.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<footer class="footer-custom">
    Panel de Director © <?php echo date("Y"); ?>. Todos los derechos reservados.
</footer>
