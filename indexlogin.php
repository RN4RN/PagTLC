...
<head>
    ...
    button {
      margin-top: 20px;
      padding: 10px 20px; 
      background-color:  rgba(22, 106, 233, 0.7);
    }
    </style>
</head>
...
<div id="modal">
  <div id="modal-content">
    ...
    <a href="https://www.google.com.pe/" style=" text-decoration: none;"><button class="button is-ghost" style="background-color: rgba(245, 53, 53, 0.7);">Decline</button></a>
  </div>
</div>
<?php endif; ?>
<body>
...
<script>
  ...
  window.onload = function() {
    fetch('terminos.php')
      ...
      .catch(error => {
        document.getElementById('terminos-texto').innerText = 'Error al cargar los términos.';
      });
  };
  <?php endif; ?>
</script>
